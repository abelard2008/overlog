...
[AC_ARG_WITH([openssllib],
	     AC_HELP_STRING([--with-openssllib],	
	                    [specify dir containing libssl (default is /usr/lib64/)]),
	     [p2_openssllib=$withval], [p2_openssllib=/usr/lib64/])
AC_CACHE_CHECK([whether to use openssllib],
	       [p2_openssllib], 
	       [p2_openssllib=/usr/lib64/])
...
[AC_ARG_WITH([boostlib],
	     AC_HELP_STRING([--with-boostlib],	
	                    [specify dir for boost libs (default is /usr/lib64)]),
	     [p2_boostlib=$withval], [p2_boostlib=/usr/lib64])
AC_CACHE_CHECK([whether to use boostlib],
	       [p2_boostlib], 
	       [p2_boostlib=/usr/lib64])
AC_SUBST(BOOST_LIB)
unset BOOST_LIB
...
[AC_ARG_WITH([pcaplib],
	     AC_HELP_STRING([--with-libpcap],	
	                    [specify dir for pcap libs (default is /usr/lib64)]),
	     [p2_pcaplib=$withval], [p2_pcaplib=/usr/lib64])
AC_CACHE_CHECK([whether to use pcaplib],
	       [p2_pcaplib], 
	       [p2_pcaplib=/usr/lib64])
AC_SUBST(PCAP_LIB)
unset PCAP_LIB

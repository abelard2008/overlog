...
testPel::vtests[] = {
  ...
  TST(UINT64, SUCCESS, "-2",	"0xffffffffffffffffU -1 +"),
  // + (integer addition)
  TST(INT64, STACK_UNDERFLOW, "", "+"),
  TST(INT64, STACK_UNDERFLOW, "", "1 +"),
  ...
  TST(INT64, SUCCESS, "-1",	"1 2 -"),
  TST(INT64, SUCCESS, "2",	"1 -1 -"),
  TST(UINT64, SUCCESS, "0",	"0xffffffffffffffffU -1 -"),
  // - (subtraction)
  TST(INT64, STACK_UNDERFLOW, "",	"-"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 -"),
  TST(INT64, SUCCESS, "1",	"1 \"Hello\" -"),
  ...
  TST(UINT64, SUCCESS, "-2",	"0xffffffffffffffffU 2 *"),
  // * (integer multiplication)
  TST(INT64, STACK_UNDERFLOW, "",	"*"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 *"),
  TST(INT64, SUCCESS, "0",	"1 \"Hello\" *"),
  ...
  TST(UINT64, SUCCESS, "0x5555555555555555U",	"0xffffffffffffffffU 3 /"),
  // / (integer division)
  TST(INT64, STACK_UNDERFLOW, "",	"/"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 /"),
  TST(INT64, DIVIDE_BY_ZERO, "",	"1 \"Hello\" /"),
  ...
  TST(INT32, SUCCESS, "1",	"0xffffffffffffffffU 2 >"),
  // > (integer greater-than)
  TST(INT32, STACK_UNDERFLOW, "",	">"),
  TST(INT32, STACK_UNDERFLOW, "",	"1 >"),
  TST(INT32, SUCCESS, "1",	"1 \"Hello\" >"),
  ...
  TST(INT32, SUCCESS, "0",	"-1 -2 <"),
  TST(INT32, SUCCESS, "1",	"-2 -1 <"),
  TST(INT32, SUCCESS, "0",	"0xffffffffffffffffU 2 <"),
  // < (integer less-than)
  TST(INT32, STACK_UNDERFLOW, "",	"<"),
  TST(INT32, STACK_UNDERFLOW, "",	"1 <"),
  TST(INT32, SUCCESS, "0",	"1 \"Hello\" <"),
